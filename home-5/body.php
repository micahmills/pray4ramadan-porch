<div class="menu-wrap">
    <nav class="menu navbar">
        <div class="icon-list navbar-collapse">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" href="#description">What is Ramadan?</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#features">Sign Up</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#blog">Prayer Fuel</a>
                </li>
            </ul>
        </div>
    </nav>
        ...
        <div class="row justify-content-md-center">
            <div class="col-md-10">
                <div class="contents text-center">
                    <h1 class="wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="0.3s">Cover Ramadan with Prayer</h1>
                    <h1 class="wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="0.3s">24/7 Prayer Campaign</h1>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-6 col-sm-6">
                <div class="item-boxes wow fadeInDown" data-wow-delay="0.2s">
                    <p>Ramadan is one of the five requirements (or pillars) of Islam. During each of its 30 days, Muslims are obligated to fast from dawn until sunset. During this time they are supposed to abstain from food, drinking liquids, smoking, and sexual relations.</p>
                    <p>In Tunisia, women typically spend the afternoons preparing a big meal. At sunset, families often gather to break the fast. Traditionally the families break the fast with a drink of water, then three dried date fruits, and a multi-course meal. After watching the new Ramadan TV series, men (and some women) go out to coffee shops where they drink coffee, and smoke with friends until late into the night.</p>
                    <p>Though many Tunisians have stopped fasting in recent years, and lots of Tunisians are turned off by the hypocrisy, increased crime rates, and rudeness that is pervasive through the month, lots of Tunisians become more serious about religion during this time. Many attend the evening prayer services and do the other ritual prayers. Some even read the entire Quran (about a tenth the length of the Bible). This sincere seeking makes it a strategic time for us to pray for them.</p>
                </div>
            </div>
            <div class="col-md-6 col-sm-6">
...
<section id="features" class="section" data-stellar-background-ratio="0.2">
    <div class="container">
        ...
        <div class="row">
            <iframe src="https://tunisia.pray4movement.org/campaign_app/24hour/19e7b37ae4d3039f88e86726bde968f54314e569985e108f314fd7b082f5141f" class="shadow p-3 mb-5 bg-white" style="width:100%; height:1000px; border: 1px solid lightgrey;" ></iframe>
        </div>
    </div>
</section>
